...
type LuaVisitor interface {
	...
	// Visit a parse tree produced by LuaParser#forstat.
	...
	// Visit a parse tree produced by LuaParser#typednamelist.
	VisitTypednamelist(ctx *TypednamelistContext) interface{}
